...
<div class="max-w-6xl m-auto w-screen p-4">
	...
	<div class="grid grid-cols-1 gap-4 md:grid-cols-10">
		<Card class="bg-gradient-to-tr from-slate-300 to-blue-200 text-gray-800 md:col-span-6">
			...
			<div class="mt-auto">
				<a
					class="bg-pink-500 text-white px-4 py-2 rounded-full text-lg"
		...
		<Card
			class="bg-emerald-400 md:col-span-5 text-white bg-[url('/img/portfolio.png')] bg-contain bg-origin-padding bg-[bottom_-5rem_right_1.5rem] md:bg-[bottom_-3rem_right_1.5rem] bg-no-repeat"
		>
